...
// llvm::Function* BuildLambdaCodegen(llvm::IRBuilder<>& builder, std::shared_ptr<Object> init, std::shared_ptr<Scope> scope, bool eval_immediately) {
//     std::vector<std::shared_ptr<Object>> arguments = ListToVector(init);

//     std::vector<llvm::Value*> commands{};
//     std::vector<std::string> arguments_idx_to_name{};
